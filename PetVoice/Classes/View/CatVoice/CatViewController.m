...
@interface CatViewController ()<UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
- (NSMutableArray *)dataArr {
    if (!_dataArr) {
        _dataArr = [NSMutableArray arrayWithObjects:@"cat_paxia", @"cat_zuoxia", @"cat_tangxia", @"cat_guolai", @"cat_quchifan", @"cat_qushuijiao", @"cat_qulashi", @"cat_quweinai", nil];
    }
    return _dataArr;
}
...
- (void)setNavigationbar {
    ...
    [moreBtn setImage:[UIImage imageNamed:@"qiumaoliang"] forState:UIControlStateNormal];
    UIBarButtonItem *moreItem  = [[UIBarButtonItem alloc] initWithCustomView:moreBtn];
    self.navigationItem.leftBarButtonItem = moreItem;
    
    UIButton * button =[UIButton buttonWithType:UIButtonTypeCustom];
    [button setImage:[UIImage imageNamed:@"喵星语"] forState:UIControlStateNormal];
